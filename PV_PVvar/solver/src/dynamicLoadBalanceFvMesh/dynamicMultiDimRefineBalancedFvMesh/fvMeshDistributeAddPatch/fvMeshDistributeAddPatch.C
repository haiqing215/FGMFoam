...
namespace Foam
{
    defineTypeNameAndDebug(fvMeshDistributeAddPatch, 0);
...
void Foam::fvMeshDistributeAddPatch::inplaceRenumberWithFlip
(
...
Foam::labelList Foam::fvMeshDistributeAddPatch::select
(
...
void Foam::fvMeshDistributeAddPatch::checkEqualWordList
(
    const string& msg,
    const wordList& lst
)
...
Foam::wordList Foam::fvMeshDistributeAddPatch::mergeWordList(const wordList& procNames)
{
    List<wordList> allNames(Pstream::nProcs());
...
void Foam::fvMeshDistributeAddPatch::printMeshInfo(const fvMesh& mesh)
{
    Pout<< "Primitives:" << nl
...
void Foam::fvMeshDistributeAddPatch::printCoupleInfo
(
...
Foam::tmp<Foam::surfaceScalarField> Foam::fvMeshDistributeAddPatch::generateTestField
(
    const fvMesh& mesh
)
{
...
void Foam::fvMeshDistributeAddPatch::testField(const surfaceScalarField& fld)
{
...
Foam::autoPtr<Foam::mapPolyMesh> Foam::fvMeshDistributeAddPatch::deleteProcPatches
(
...
Foam::autoPtr<Foam::mapPolyMesh> Foam::fvMeshDistributeAddPatch::repatch
(
...
// merge those points.
Foam::autoPtr<Foam::mapPolyMesh> Foam::fvMeshDistributeAddPatch::mergeSharedPoints
(
...
void Foam::fvMeshDistributeAddPatch::getCouplingData
(
...
void Foam::fvMeshDistributeAddPatch::subsetCouplingData
(
    const fvMesh& mesh,
...
void Foam::fvMeshDistributeAddPatch::findCouples
(
    const primitiveMesh& mesh,
    const labelList& sourceFace,
    const labelList& sourceProc,
...
Foam::labelList Foam::fvMeshDistributeAddPatch::mapBoundaryData
(
...
Foam::labelList Foam::fvMeshDistributeAddPatch::mapPointData
(
    const primitiveMesh& mesh,      // mesh after adding
    const mapAddedPolyMesh& map,
    const labelList& boundaryData0, // on mesh before adding
...
Foam::autoPtr<Foam::mapPolyMesh> Foam::fvMeshDistributeAddPatch::doRemoveCells
(
...
void Foam::fvMeshDistributeAddPatch::addProcPatches
(
...
Foam::labelList Foam::fvMeshDistributeAddPatch::getBoundaryPatch
(
...
void Foam::fvMeshDistributeAddPatch::sendMesh
(
    const label domain,
    const fvMesh& mesh,
...
Foam::autoPtr<Foam::fvMesh> Foam::fvMeshDistributeAddPatch::receiveMesh
(
    const label domain,
    const wordList& pointZoneNames,
    const wordList& faceZoneNames,
...
Foam::fvMeshDistributeAddPatch::fvMeshDistributeAddPatch(fvMesh& mesh, const scalar mergeTol)
:
    mesh_(mesh),
    mergeTol_(mergeTol)
{}
...
Foam::labelList Foam::fvMeshDistributeAddPatch::countCells
(
    const labelList& distribution
)
{
...
Foam::autoPtr<Foam::mapDistributePolyMesh> Foam::fvMeshDistributeAddPatch::distribute
(
    const labelList& distribution
)
{
    ...
    (
        "oldInternalFaces",
        0, // create empty
        mesh_.nFaces(), // starting at the end
        mesh_.boundaryMesh().size(),
        patches,
        polyPatch::typeName
    );

    label oldInternalPatchi = fvMeshTools::addPatch
    (
        mesh_,
        pp,
        dictionary(),   // optional per field patchField
    ...
    // remove temperorary calculated patches
    fvMeshTools::removeEmptyPatches
    (
        mesh_,
        true
    );
